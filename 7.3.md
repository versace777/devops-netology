...
---
```
devops@devops:~$ terraform workspace list
          default          
        * prod
          stage
```
```
devops@devops:~$ terraform plan
...
Terraform will perform the following actions:
  ...
  + resource "yandex_compute_instance" "vm-c" {
      + created_at                = (known after apply)
      + folder_id                 = (known after apply)
  ...
  # yandex_compute_instance.vm2 will be created
  + resource "yandex_compute_instance" "vm-c" {
      + created_at                = (known after apply)
      + folder_id                 = (known after apply)
      + fqdn                      = (known after apply)
  ...
  + resource "yandex_compute_instance" "vm-f" {
      + created_at                = (known after apply)
      + folder_id                 = (known after apply)
      + fqdn                      = (known after apply)
      + hostname                  = (known after apply)
